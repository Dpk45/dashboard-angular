...
export class ProductService {
  ...
  updateProductById(brand, productId, updateProductData) {
    ...
    brand = brand + '_dev';
    const body: any = JSON.stringify(updateProductData);
  ...
  createProduct(brand, productData) {
    ...
    brand = brand + '_dev';
    const body: any = JSON.stringify(productData);
    console.log('body>>>>>>>>>>>>>>>>>>', body);
    const _path: string = (this.baseUrl + '/products/?key=' + brand);
    return this._httpClient.post(_path, body)
      .map((res: any) => {
  ...
  createProductCollection(brand, productCollectionData) {
    brand = brand + '_dev';
    const body: any = JSON.stringify(productCollectionData);
    const _path: string = (this.baseUrl + '/products/collections?key=' + brand);
    return this._httpClient.post(_path, body)
      .map((res: any) => {
        return res;
  ...
  assignUpcCode(brand, productId, description) {
    brand = brand + '_dev';
    const body: any = JSON.stringify(description);
